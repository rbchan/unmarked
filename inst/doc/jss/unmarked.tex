...
Here, counts of organisms are made during J visits to each of M sites.}
\end{centering}
\label{tab:exdata}
\end{table}
...
\end{Sinput}
\begin{Soutput}
Call: parboot(object = fm.oven.1, statistic = chisq, nsim = 10)

Parametric Bootstrap Statistics:
   t0 mean(t0 - t_B) StdDev(t0 - t_B) Pr(t_B > t0)
1 301           23.4             34.3        0.273

t_B quantiles:
     0% 2.5% 25% 50% 75% 97.5% 100%
t*1 232  235 252 271 301   334  342
